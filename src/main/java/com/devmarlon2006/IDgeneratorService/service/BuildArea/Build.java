...
public class Build {
    ...
    public static String Four(String PARAMETER_1, String PARAMETER_2, String PARAMETER_3, int PARAMETER_4){
    ...
    public static String Five(String PARAMETER_1, String PARAMETER_2, String PARAMETER_3, int PARAMETER_4){

        List <String> CompleteID = new ArrayList<>(); //20 characters

        CompleteID.add( By.ByName( PARAMETER_1 ).orElse( "" ) ); // Bloco 1
        CompleteID.add(By.ByAge(PARAMETER_4).orElse( "" )); // Bloco 3
