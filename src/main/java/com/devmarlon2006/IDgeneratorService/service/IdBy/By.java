package com.devmarlon2006.IDgeneratorService.service.IdBy;

import com.devmarlon2006.IDgeneratorService.service.BuildArea.ElementsLogic.IDelemntAllowed;
import com.devmarlon2006.IDgeneratorService.service.BuildArea.ElementsLogic.randomElements;
import com.devmarlon2006.IDgeneratorService.service.erroArea.CustomExeption.CustomsExeptions;
import com.devmarlon2006.IDgeneratorService.service.erroArea.ErroMethods;
...
public class By {
    ...
    public static Optional<String> ByState(String State_3){
        ...
        try{
            ...
            CustomsExeptions.validateTableSize( table, 4 ); //Lançamento de exceção
